  ...
  "usa-aus": {
    ...
    "playerDuel": {
      "home": {
        ...
        "role": "左翼锋/队长",
        "color": "#3b82f6",
        "details": "美国队长（30球），拥有顶级的带球内切变向与门前致命爆破，是美国队在反击和压迫时的进攻尖刀。"
      },
      "away": {
        "name": "哈里·苏塔尔",
        "jersey": "19",
    ...
    "tactics": {
      "homeForm": "4-3-3",
      "awayForm": "4-4-2",
      "explanation": "美国队采用高强度压迫 4-3-3 阵型，麦肯尼、穆萨在中场进行大范围的扫荡和插上，两翼普利西奇与维阿利用极致的速度进行边路穿插，撕扯澳大利亚的防线。澳大利亚则排出稳健的 4-4-2 防守两道防线，中场进行深度落位，反击时依靠两翼的传中寻找门前的莱基和突前的公牛杜克，或者利用定位球长传冲吊轰炸美国防区。",
      "players": [
      ...
      "away": [
        {
          ...
          "defenseDefense": "协助中场退守拦截土耳其卡迪奥卢的压上助攻，就地发起极速单人反击。",
...
// Let's write it back to data.json beautifully formatted
fs.writeFileSync(dataPath, JSON.stringify(data, null, 2), 'utf8');
console.log('data.json upgraded successfully with 4 new matches!');
